...
本文件整理项目中有保留价值的中间实验结果，便于在 GitHub 上展示完整探索过程。最终主结果见 `README.md` 和 `REPORT.md`；这里重点补充“图像增强 + 应用层后处理”的探索实验。

## 1. Source Augmentation Baseline
...
## 2. Application-Layer Post-Processing
